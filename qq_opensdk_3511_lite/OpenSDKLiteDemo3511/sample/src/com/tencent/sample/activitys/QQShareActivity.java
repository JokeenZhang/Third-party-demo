...
public class QQShareActivity extends BaseActivity implements OnClickListener, OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRadioBtnEmptyArk = (RadioButton) findViewById(R.id.radioBtn_empty_ark);
        mRadioBtnEmptyArk.setOnClickListener(this);
        mRadioBtnDefaultArk = (RadioButton) findViewById(R.id.radioBtn_default_ark);
        mRadioBtnDefaultArk.setOnClickListener(this);
        ...
        switch (v.getId()) {
            case R.id.shareqq_commit: // 提交
                ...
                if (shareType == QQShare.SHARE_TO_QQ_MINI_PROGRAM) {
                    ...
                    miniProgramBundle.putInt(QQShare.SHARE_TO_QQ_EXT_INT, mExtarFlag);
            ...
            case R.id.radioBtn_share_type_mini_program:
                ...
                break;
            case R.id.radioBtn_empty_ark:
                arkInfo.setText("");
                break;
            case R.id.radioBtn_default_ark:
